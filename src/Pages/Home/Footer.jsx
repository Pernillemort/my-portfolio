  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo-final.png" alt="Logofinal" className="logo--footer"/>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/pernillemus"
            ...
            <li>
              <a
                href="https://www.instagram.com/pernille__mortensen/?hl=da"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://x.com/Pernille_Mort98"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
                ...
                >
                  <path
                    d="M19.695 2H23L15.577 10.144L24 22h-6.873l-5.364-7.539L5.69 22H2l8.008-8.855L0 2h7.058l4.77 6.693L19.695 2ZM18.28 20h1.74L6.06 4H4.216L18.28 20Z"
                    fill="black"
                  />
                </svg>
              </a>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/pernille-mortensen-9b3484209/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Pernille Mortensen</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
